...
#배경 이미지 불러오기
background = pygame.image.load("C:\\Users\\ssw82\\Desktop\\PyThon\\python\\paperback.jpg")


#캐릭터 (스프라이트) 불러오기
character = pygame.image.load("C:\\Users\\ssw82\\Desktop\\PyThon\\python\\dog.png")
...
# 몬스터 캐릭터
enemy = pygame.image.load("C:\\Users\\ssw82\\Desktop\\PyThon\\python\\ddong.jpg")
enemy_size = enemy.get_rect().size # 이미지 크기
enemy_width = enemy_size[0] # 캐릭터의 가로 크기
enemy_height = enemy_size[1] # 캐릭터의 새로 크기
enemy_x_pos = random.randint(0,screen_width - enemy_width) #random.randrange(screen_width) #화면 가로의 절반 크기에 해당하는 곳에 위치(가로)
